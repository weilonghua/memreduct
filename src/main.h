...
#define ICON_CACHE_SIZE 101

#define DEFAULT_AUTOREDUCT_VAL 85
#define DEFAULT_AUTOREDUCTINTERVAL_VAL 30
#define DEFAULT_AUTOREDUCT_COOLDOWN_SEC (5 * 60)
#define DEFAULT_AUTOREDUCT_LOW_EFFECT_BACKOFF_SEC (30 * 60)
#define DEFAULT_AUTOREDUCT_LOW_EFFECT_BYTES (128ULL * 1024ULL * 1024ULL)

#define DEFAULT_DANGER_LEVEL 95
#define DEFAULT_WARNING_LEVEL 85
...
typedef enum _CLEANUP_REASON_FLAGS
{
	CLEANUP_REASON_PERCENT = 0x01,
	CLEANUP_REASON_INTERVAL = 0x02
} CLEANUP_REASON_FLAGS;
